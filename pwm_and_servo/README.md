...
Output (all Pi's except Pi 5):  
12: ip    -- | lo // GPIO12 = input  
13: ip    -- | lo // GPIO13 = input  
18: a5    -- | lo // GPIO18 = PWM0 &nbsp;&nbsp;&nbsp;&nbsp; (enabled by default)  
19: a5    -- | lo // GPIO19 = PWM1 &nbsp;&nbsp;&nbsp;&nbsp; (enabled by default)  

**Enable IO's for PWM (all Pi's except Pi 5):**
```bash
...
18: a3    pd | lo // GPIO18 = PWM0_CHAN2 &nbsp;&nbsp;&nbsp;&nbsp; (enabled by default)  
19: a3    pd | lo // GPIO19 = PWM0_CHAN3 &nbsp;&nbsp;&nbsp;&nbsp; (enabled by default)  

**Enable IO's for PWM (Pi 5 only):**
```bash
sudo pinctrl set 12 a0
sudo pinctrl set 13 a0
...
### Request and and control PWM IO

**(1) Request PWM channel 0:**
```bash
echo 0 > /sys/class/pwm/pwmchip0/export
```

**(2) Set PWM frequency to 50Hz (Period 20ms = 20000000ns):**
```bash
echo 20000000 > /sys/class/pwm/pwmchip0/pwm0/period
```

**(3) Set Duty Cycle to 10% (2ms = 2000000ns):**
```bash
...
**(1) Request PWM channel 0 of pwmchip1 (GPIO 4):**
```bash
...
**(2) Release PWM channel 0 of pwmchip1 (GPIO 4):**
```bash
